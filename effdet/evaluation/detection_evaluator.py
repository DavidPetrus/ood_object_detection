...
class ObjectDetectionEvaluator(DetectionEvaluator):
    ...
    def add_single_ground_truth_image_info(self, image_id, gt_dict):
        ...
        gt_classes = gt_dict['cls'] - self._label_id_offset
    ...
    def add_single_detected_image_info(self, image_id, detections_dict):
        ...
        """
        detection_classes = detections_dict['cls'] - self._label_id_offset
        ...
        self._evaluation.add_single_detected_image_info(
            image_key=image_id,
            detected_boxes=detections_dict['bbox'],
            detected_scores=detections_dict['scores'],
            detected_class_labels=detection_classes,
            detected_masks=detection_masks)

    def evaluate(self,task_categories):
        ...
        for idx,category_name in enumerate(task_categories):
            ...
            if self._evaluate_corlocs:
                display_name = 'CorLoc@{}IOU/{}'.format(self._matching_iou_threshold, category_name)
                pascal_metrics[display_name] = metrics['per_class_corlocs'][idx]
